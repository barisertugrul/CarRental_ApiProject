...
namespace Business.Concrete
{
    public class CarImageManager : ICarImageService
    {
        ...
        {
            List<IResult> errorResults = BusinessRules.Run(CheckIfCarImageLimitExceeded(carImage.CarId));
            ...
            string message = "";
            foreach (IResult result in errorResults)
            {
        ...
        //Todo varolan get ve getall içerisinde kullanılacak şekilde düzenle
